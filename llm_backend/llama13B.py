...
class Llama13BInference:
    def __init__(self):
        self.model_size = "13b"
        engine_path = "llama_models/llama-13b.engine"
    ...
    def save_engine(self):
        engine_output_path = "llama_models/llama-13b-optimized.engine"
...
if __name__ == "__main__":
    print("Running inference for LLaMA-13B on single GPU")
    llama = Llama13BInference()
