...
class Llama33BInference:
    def __init__(self):
        self.model_size = "33b"
        engine_path = "llama_models/llama-33b.engine"
        self.tokenizer = LlamaTokenizer.from_pretrained("meta-llama/Llama-2-33b-hf")
        self.model = trtllm.TRTLLM(engine_path, use_flash_attention=True)
        
        pynvml.nvmlInit()
        self.handle = pynvml.nvmlDeviceGetHandleByIndex(0)
        
        torch.cuda.set_device(0)
        self.device_map = {0: "cuda:0", 1: "cuda:1"}
    ...
    def save_engine(self):
        engine_output_path = "llama_models/llama-33b-optimized.engine"
...
if __name__ == "__main__":
    print("Running inference for LLaMA-33B on two GPUs with Flash Attention")
    llama = Llama33BInference()
