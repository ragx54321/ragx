...
def run_benchmark(queries_file, output_csv, model, index_file, iterations, max_queries, batch_size, num_threads):
    """
...
if __name__ == "__main__":
    ...
    queries_file = 'QUERIES PATH'
    output_index_file = "HNSW PATH"
    output_csv = "OUTPUT PATH"
    max_queries = 1
    iterations = 1  # Number of iterations for embedding and searching
    batch_size = 1  # Replicate each query 10 times
    ...
    run_benchmark(queries_file, output_csv, model, output_index_file, iterations, max_queries, batch_size, num_threads)
